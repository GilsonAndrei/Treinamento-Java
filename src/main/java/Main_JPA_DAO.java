...
public class Main_JPA_DAO {
	public static void main(String[] args) throws IOException, ParseException {
		...
		VeiculoDaoJPA veiculoDao = new VeiculoDaoJPA(em, Veiculo.class);
		...
		CondutorDaoJPA condutorDao = new CondutorDaoJPA(em, Condutor.class);
		...
		//########################################### Lista todos Eventos ###########################################
		EventoDaoJPA eventoDao = new EventoDaoJPA(em, Evento.class);
